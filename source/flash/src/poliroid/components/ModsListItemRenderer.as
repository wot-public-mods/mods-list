package poliroid.components {
	...
	public class ModsListItemRenderer extends SoundListItemRenderer {
		...
		override protected function configUI(): void {
			...
			this._images.button_default = new imageButtonDefault() as Bitmap;
			...
			this._images.button_disabled = new imageButtonDisabled() as Bitmap;
			this._images.button_disabled.visible = false;
			this.addChild(this._images.button_disabled);
			
			this._images.alert_icon = new imageAlertIcon() as Bitmap;
